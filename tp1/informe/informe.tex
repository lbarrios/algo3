...
\section{Desarrollo del TP}
	...
	%-- Problema 1 --
	\subsection{Problema 1: NOMBREDELPROBLEMA}
	\input{problema1}
	\newpage
	
	%-- Problema 2 --
	\subsection{Problema 2: NOMBREDELPROBLEMA}
	\input{problema2}
	\newpage
	
	%-- Problema 3 --
	\subsection{Problema 3: NOMBREDELPROBLEMA}
	\input{problema3}
	\newpage
...
%		\bibitem{wiki:back} \texttt{http://en.wikipedia.org/wiki/Backtracking\#Usage\_considerations}
	...
	\clearpage{\pagestyle{empty}\input{instrucciones}\clearpage} % el triangulito
