...
# generador de Test genérico. Después lo voy a mover a common
...
class generadorDeTestsEj1 (generadorDeTests):
  ...
  def generarTest(self, n, nombre, cantCasos = 1000):
    ...
    genCasos = nombresPosibles.get(nombre)
    if not genCasos:
      raise Exception("Nombre debe pertenecer a la lista: [ {} ]".format( " ,".join( [ key for key in nombresPosibles.keys() ])))
...
if __name__ == '__main__':
  ...
  coso.generarTest(1, "casoAleatorio")
