...
\ForAll{i in 1 to n - k} \Comment{ \bigO{(n * (n-k)) = \bigO{(n^2)}}} 
	...
	\State CCAUnir1.aristas = CCAUnir1.aristas union CCAUnir2.aristas + aristaMasCorta entre CCAUnir1 y CCAUnir2 \Comment{ \bigO{1}}
	...
	\ForAll{i in 1 to n} \Comment{ \bigO{n}} 
		\State si componentesConexas[i] ya no representa una componente conexa, continúo \Comment{ \bigO{1}} 
        ...
        \State y lo mismo actualizo para la distancia y arista mas corta desde CCAUnir1 hacia la CC i \Comment{ \bigO{1}} 
